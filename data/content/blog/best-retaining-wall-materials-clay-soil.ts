...
const post: BlogPost = {
  slug: 'best-retaining-wall-materials-clay-soil',
  title: 'Best Retaining Wall Materials for Puget Sound Clay Soil',
  metaTitle: 'Best Retaining Wall Materials for Puget Sound Clay Soil (2026)',
  metaDescription:
    'Which retaining wall materials hold up in Puget Sound clay and glacial till: segmental block, basalt boulder, gabion, poured concrete, timber and rockery compared on cost, service life and drainage behavior.',
  ...
  excerpt:
    'Most of what people around here call clay is dense glacial till, and it breaks walls in one specific way. Here is how block, basalt, gabion, concrete, timber and rockery actually perform in it.',
  blocks: [
    {
      type: 'p',
    ...
    { type: 'h2', text: 'Choosing by site rather than by catalog' },
    {
      type: 'ol',
      items: [
  ...
  faqs: [
    {
      question: 'Does the city treat a rockery as a retaining wall?',
      answer:
    ...
    {
      question: 'Why do block walls here grow moss and white streaks?',
      answer:
    ...
    {
      question: "The reinforced zone would run into my neighbor's yard. Is that a problem?",
      answer:
    ...
    {
      question: 'Water seeps out of my slope above where the wall would go. Does the wall drain catch it?',
      answer:
    ...
    {
      question: 'Can I plant a slope instead of walling it?',
      answer:
  ...
  relatedCities: ['renton', 'maple-valley', 'covington', 'west-seattle', 'kent'],
  readingMinutes: 6,
};
