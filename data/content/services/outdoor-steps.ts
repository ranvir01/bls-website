...
const content: ServiceContent = {
  ...
  process: [
    {
      title: 'Measure the rise and set the math',
      description:
    ...
    {
      title: 'Stake the layout and walk it',
      description:
    ...
    {
      title: 'Excavate and build the base',
      description:
    ...
    {
      title: 'Set the bottom course dead level',
      description:
    ...
    {
      title: 'Build the flight with drainage behind it',
      description:
    ...
    {
      title: 'Backfill, plant and clean',
      description:
  ...
  costRows: [
    {
      item: 'Segmental block steps with cap treads',
      range: '$250-$450',
      unit: 'per linear foot of tread',
      notes: 'Assumes 4 ft wide flight; wider treads scale the number',
    },
    {
      item: 'Natural granite or basalt slab treads',
      range: '$450-$800',
      unit: 'per linear foot of tread',
      notes: 'Slab weight often requires machine placement',
    },
    {
      item: 'Poured concrete steps, broom finish',
      range: '$180-$340',
      unit: 'per linear foot of tread',
    },
    {
      item: 'Cheek walls flanking a flight',
      range: '$50-$85',
      unit: 'per face sq ft',
    },
    {
      item: 'Powder-coated aluminum handrail',
      range: '$95-$185',
      unit: 'per linear foot',
    },
    {
      item: 'Low-voltage riser or step lighting',
      range: '$110-$200',
  ...
  faqs: [
    ...
    {
      question: 'Can you replace railroad tie steps?',
      answer:
    ...
    {
      question: 'Do outdoor steps need a footing below frost depth?',
      answer:
    ...
    {
      question: 'How do I keep the steps from getting slippery in winter?',
      answer:
  ...
  relatedServices: ['retaining-walls', 'walkways', 'paver-patios'],
  keywords: [
    'outdoor steps contractor Kent WA',
    'garden stairs installation Seattle',
    'railroad tie step replacement King County',
    'stone step installation cost Washington',
    'block steps for sloped backyard',
    'hillside stairs Renton',
    'outdoor stair handrail code Washington',
  ],
};
