    ...
    <section className="bg-black py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-blue-400 mb-3">Contact Seattle's Hardscaping & Irrigation Experts</h2>
          <p className="text-gray-400 max-w-2xl mx-auto">
            Get in touch to discuss your hardscaping or irrigation project in Seattle. Our specialists are ready to help solve your property's unique challenges.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Contact Info Card */}
          <div className="bg-teal-800 text-white p-6 rounded-lg shadow-md">
