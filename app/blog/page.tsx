    ...
    <>
      ...
      <div className="shell pb-16 pt-8">
        <header className="max-w-3xl">
          <p className="text-caption font-semibold uppercase tracking-wide text-moss-700">Guides</p>
          ...
          {blogPosts.map((post, i) => (
            <Reveal as="li" key={post.slug} delay={Math.min(i * 0.05, 0.2)}>
              ...
              >
                ...
                <h2 className="mt-2 text-h3 group-hover:text-moss-700">{post.title}</h2>
                <p className="mt-3 flex-1 text-body text-stone-500">{post.excerpt}</p>
                <span className="mt-4 text-caption font-semibold text-moss-700 underline underline-offset-4">
                  Read the guide
                </span>
              </Link>
            </Reveal>
