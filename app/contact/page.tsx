    ...
    <>
      ...
      <div className="shell pb-16 pt-8">
        <header className="max-w-3xl">
          <p className="text-caption font-semibold uppercase tracking-wide text-moss-700">Contact</p>
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3">
          <a
            href={TEL_HREF}
            className="flex min-h-[88px] flex-col justify-center gap-1 rounded-sm border border-stone-200 bg-white p-5 transition-colors hover:border-moss-700"
          >
            <span className="flex items-center gap-2 text-caption font-semibold uppercase tracking-wide text-moss-700">
              <Phone className="h-4 w-4" aria-hidden="true" />
              Call
            </span>
            <span className="text-body-lg font-semibold text-stone-950">{PHONE.display}</span>
          </a>
          <a
            href={SMS_HREF}
            className="flex min-h-[88px] flex-col justify-center gap-1 rounded-sm border border-stone-200 bg-white p-5 transition-colors hover:border-moss-700"
          ...
          <div className="flex min-h-[88px] flex-col justify-center gap-1 rounded-sm border border-stone-200 bg-white p-5">
            <span className="flex items-center gap-2 text-caption font-semibold uppercase tracking-wide text-moss-700">
              <Clock className="h-4 w-4" aria-hidden="true" />
              Response time
            </span>
            <span className="text-body-lg font-semibold text-stone-950">Same day</span>
          </div>
        </div>
        ...
        <div className="mt-14 grid gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <aside className="min-w-0 space-y-8 lg:col-span-5">
            ...
            <section className="rounded-sm border border-stone-200 bg-white p-6">
              ...
              <p className="mt-2 text-body text-stone-500">{formattedAddress}</p>
